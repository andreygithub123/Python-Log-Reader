...
def ex8(logs):
    ...
    for log in sorted_log_entries:
        if log["timestamp"][:2] != present_hour:
            ...
            # print("Hour: " + present_hour)
            # if max(api, backend, frontend) == api:
            #     print("API: " + str(int(api)))
            # if max(api, backend, frontend) == backend:
            #     print("Backend: " + str(int(backend)))
            # if max(api, backend, frontend) == frontend:
            #     print("Frontend: " + str(int(frontend)))
            # print("----------")
